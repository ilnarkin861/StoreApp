    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CategoryId = table.Column<int>(type: "integer", nullable: false),
                    PropertyGroupId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Filters_PropertyGroups_PropertyGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FilterProperty", x => new { x.FiltersId, x.PropertiesId });
                    table.ForeignKey(
                        name: "FK_FilterProperty_Filters_FiltersId",
                        column: x => x.FiltersId,
                        principalTable: "Filters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FilterProperty_Properties_PropertiesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FilterProperty_PropertiesId",
                table: "FilterProperty",
                column: "PropertiesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Filters_PropertyGroupId",
                table: "Filters",
